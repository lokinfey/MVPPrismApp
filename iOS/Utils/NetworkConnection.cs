...
namespace MVPPrismApp.iOS.Utils
{
    public class NetworkConnection : INetworkConnection
    {
        ...
        private bool IsAdHocWiFiNetworkAvailable(out NetworkReachabilityFlags flags)
        {
            ...
            {
                adHocWiFiNetworkReachability = new NetworkReachability("www.163.com");
                adHocWiFiNetworkReachability.SetNotification(OnChange);//.SetCallback(OnChange);
        ...
        private bool InternetConnectionStatus()
        {
            ...
            //if (defaultNetworkAvailable && ((flags ) != 0))
            //{
            //  return false;
            //}
